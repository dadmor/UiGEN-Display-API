...
<html lang="en">
	...
	require_once( get_template_directory() . '/uigen-display-api/inc/functions.php' );
	/* LOAD YAML -> PHP PARSER */
	require_once UIGENCLASS_PATH . 'Spyc.php';
	/* INIT UiGEN DISPLAY API CLASS */
	require_once get_template_directory() . '/uigen-display-api/inc/uigen-display-api.class.php';
	$UIGEN_API = new UiGEN_display_api();

	$menu_prefix = get_template_directory_uri().'/uigen-display-api/content/';
...
<!--     <link rel="icon" href="../../favicon.ico"> -->
    ...
    <!-- Bootstrap core CSS -->
   	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/uigen-display-api/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/uigen-display-api/bootstrap/css/bootstrap-theme.min.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/uigen-display-api/css/colorize-github.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/uigen-display-api/css/jquery.json-editor.css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/uigen-display-api/css/alpaca-bootstrap.css">
	<style>
	...
	<script>
		/* print JS CONST */
		<?php
			echo "var PHP_API_CLASS = '".get_template_directory_uri()."/uigen-display-api/inc/uigen-display-api.class.php';\n";
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/bootstrap/js/bootstrap.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/uigen-display-api.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/rainbow-custom.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/uigen_tree.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/json2.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/jquery.json-editor.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/jquery.tmpl.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/uigen-display-api/js/alpaca.js"></script>
